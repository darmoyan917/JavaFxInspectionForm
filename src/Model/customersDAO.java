...
public class customersDAO {
    ...
    //INSERT a vehicle
    //*************************************
    public static void insertCustomer(int customerID, String firstName, String lastName, String address, String city, String state, String zipCode, String vinNumber, String email) throws SQLException, ClassNotFoundException {
        //Declare a DELETE statement
        String updateStmt =

                "INSERT INTO customers" + "\n" +
                        "VALUES\n" +
                        "('" + customerID + "','" + firstName + "', '" + lastName + "','" + address + "','" + city + "','" + state + "','" + zipCode + "','" + email + "','" + vinNumber + "');\n";
